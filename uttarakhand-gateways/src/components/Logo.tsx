...
export const Logo: React.FC<LogoProps> = ({ 
  ...
  return (
    <div className={`flex items-center gap-3 select-none ${className}`}>
      {/* Cloud & Himalayan Peaks Logo matching user inspiration */}
      <div 
      ...
      >
        ...
        >
          ...
          <g clipPath="url(#ukCloudClip)">
            ...
            {/* --- LOWER WHITE PUFFY CLOUDS FRAMING THE BASE --- */}
            {/* Left Cloud Cluster */}
            <path 
            ...
            />
            {/* Pure white highlight on left cloud */}
            <path 
            ...
            <path 
              ...
              fill="url(#cloudShadow)" 
            />
            {/* Pure white highlight on right cloud */}
            <path 
      ...
      <div className="flex flex-col justify-center leading-tight">
        <span className={`font-semibold text-white tracking-tight ${titleSizes[size]} font-sans drop-shadow-sm`}>
          Uttarakhand
        </span>
        <span className={`font-semibold text-amber-400 font-sans uppercase ${gatewaySizes[size]} drop-shadow-sm`}>
          GATEWAYS
        </span>
        {showTagline && (
